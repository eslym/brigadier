...
describe('StringReader Test', () => {
	...
	it('readQuotedString_noOpen', () => {
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedStartOfQuote());
	...
	it('readQuotedString_noClose', () => {
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedEndOfQuote());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 12);
		}
	})
	...
	it('readQuotedString_invalidEscape', () => {
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidEscape());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 7);
		}
	})
	...
	it('readInt_invalid', () => {
		try {
			...
			assert.deepEqual(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidInt());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
	...
	it('readInt_none', () => {
		try {
			...
			assert.deepEqual(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedInt());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
	...
	it('readFloat_invalid', () => {
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidFloat());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
	...
	it('readFloat_none', () => {
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedFloat());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
	...
	it('expect_incorrect', () => {
		...
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedSymbol());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
	...
	it('readBoolean_incorrect', () => {
		...
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidBool());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
	...
	it('readBoolean_none', () => {
		...
		try {
			...
			assert.equal(CommandSyntaxException.prototype.getType.call(ex), CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedBool());
			assert.equal(CommandSyntaxException.prototype.getCursor.call(ex), 0);
		}
	})
})