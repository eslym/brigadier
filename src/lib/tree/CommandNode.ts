...
abstract class CommandNode<S> {
    ...
    protected constructor (command: Command<S>, requirement: Predicate<S>, redirect: CommandNode<S>, modifier: RedirectModifier<S>, forks: boolean) {
        ...
        this.requirement = requirement || (async () => true);
    ...
    public async canUse(source: S): Promise<boolean> {
    ...
    public equals(o: object): boolean {
		...
		return !(this.command != null ? !isEqual(this.command, o.command) : o.command != null);
    }
